            ...
            <section class="properties">
                <div class="container">
                    <ul class="propertyCat_list option-set">
                        <li>
                            <a href="/admin/listings/submissions"
                               data-filter="*"
                               @if(Request::is('admin/listings/submissions'))
                        ...
                        <li>
                            <a href="/admin/listings/submissions/Sale"
                               data-filter="*"
                               @if(Request::is('admin/listings/submissions/Sale'))
                               class="current triangle"
                                    @endif >
                                FOR SALE
                            </a>
                        ...
                        <li>
                            <a href="/admin/listings/submissions/Rent"
                               data-filter="*"
                               @if(Request::is('admin/listings/submissions/Rent'))
                               class="current triangle"
                                    @endif >
                                FOR RENT
                            </a>
                        ...
                        <li>
                            <a href="/admin/listings/submissions/Lease"
                               data-filter="*"
                               @if(Request::is('admin/listings/submissions/Lease'))
                               class="current triangle"
                                    @endif >
                                FOR LEASE
                            </a>
                                            ...
                                            <div class="col-lg-8 rowText">
                                                ...
                                                <table border="1" class="propertyDetails">
                                                    <tr>
                                                        ...
                                                        <td class="approve-listing" data-id="{{$listing->id}}">
                                                            Approve
                                                        </td>
